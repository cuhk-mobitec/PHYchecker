...
if __name__ == '__main__':
    ...
    # camera2 API
    target_start = [('Landroid/hardware/camera2/CameraDevice;','createCaptureSession'), ('Landroid/hardware/camera2/CameraManager;','openCamera')]
    target_close = [('Landroid/hardware/camera2/CameraDevice;','close')]
